...
/// Historical context card for phenomenon detail screens
/// Displays historical and cultural context of cosmic phenomena
class PhenomenonHistoricalCard extends StatelessWidget {
  final List<String> episodes;
  final int episodeIndex;
  final Color accentColor;

  const PhenomenonHistoricalCard({
    super.key,
